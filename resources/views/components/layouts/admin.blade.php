    ...
    >
        ...
        <div class="px-3 py-3 border-b border-slate-100 flex-shrink-0" x-show="sidebarOpen" x-cloak>
            <div x-data="{ open: false }" class="relative">
                <button
                    @click="open = !open"
                    class="w-full flex items-center gap-2.5 px-2.5 py-2 rounded-lg bg-slate-50 border border-slate-200/80 text-left hover:bg-slate-100/80 transition-colors"
                    id="tenant-switcher-btn"
                >
                    <div class="w-7 h-7 rounded-md bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center flex-shrink-0 shadow-sm">
                    ...
                    <div class="overflow-hidden flex-1 min-w-0">
                        ...
                        <p class="text-[10px] text-slate-400 truncate leading-tight">acme.possaas.com</p>
                    </div>
                ...
                <div
                    ...
                    x-cloak
                >
                    <div class="px-3 py-1.5 text-[10px] font-bold text-slate-400 uppercase tracking-widest">Switch Store</div>
                    <button class="w-full flex items-center gap-2.5 px-3 py-2 hover:bg-slate-50 text-left">
                        <div class="w-6 h-6 rounded-md bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center shadow-sm">
                            <span class="text-[9px] font-bold text-white">A</span>
                        </div>
                        <div><p class="text-xs font-medium text-slate-700">Acme Store</p></div>
                        <svg class="w-3.5 h-3.5 text-blue-500 ml-auto" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg>
                    </button>
                    <button class="w-full flex items-center gap-2.5 px-3 py-2 hover:bg-slate-50 text-left">
                        <div class="w-6 h-6 rounded-md bg-gradient-to-br from-violet-500 to-violet-600 flex items-center justify-center shadow-sm">
                            <span class="text-[9px] font-bold text-white">B</span>
                        </div>
                        <div><p class="text-xs font-medium text-slate-700">Beta Market</p></div>
                    </button>
